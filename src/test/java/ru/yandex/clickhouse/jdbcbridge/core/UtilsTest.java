...
public class UtilsTest {
    ...
    public void testSingleJavaObjectToArrays() {
        ...
        assertArrayEquals(Utils.toObjectArrays('C', multiColumns), new Object[][] { new Object[] { 'C', null } });

        assertArrayEquals(Utils.toObjectArrays((boolean) false), new Object[][] { new Object[] { (boolean) false } });
        ...
        assertArrayEquals(Utils.toObjectArrays((byte) 5, singleColumn), new Object[][] { new Object[] { (byte) 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays((short) 5, singleColumn), new Object[][] { new Object[] { (short) 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays((int) 5, singleColumn), new Object[][] { new Object[] { (int) 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays((long) 5, singleColumn), new Object[][] { new Object[] { (long) 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays((double) 5.55), new Object[][] { new Object[] { (double) 5.55 } });
        ...
        assertArrayEquals(Utils.toObjectArrays("5x5x", singleColumn), new Object[][] { new Object[] { "5x5x" } });
        assertArrayEquals(Utils.toObjectArrays("5x5x", multiColumns), new Object[][] { new Object[] { "5x5x", null } });
        ...
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns), new Object[][] { new Object[] { value, null } });
        ...
        assertArrayEquals(Utils.toObjectArrays(Collections.enumeration(Collections.singletonList(5)), singleColumn),
                new Object[][] { new Object[] { 5 } });
        assertArrayEquals(Utils.toObjectArrays(Collections.enumeration(Collections.singletonList(5)), multiColumns),
        ...
        assertArrayEquals(Utils.toObjectArrays(Collections.singletonList(5)), new Object[][] { new Object[] { 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays(Collections.singleton(5)), new Object[][] { new Object[] { 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { value } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn), new Object[][] { new Object[] { value } });
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns), new Object[][] { new Object[] { null, null } });

        value = Collections.singletonMap("b", 6);
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { value } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn), new Object[][] { new Object[] { value } });
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns), new Object[][] { new Object[] { null, 6 } });
    }
    ...
    public void testMultipleJavaObjectsToArrays() {
        ...
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { 'C' }, new Object[] { 'd' } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn),
                new Object[][] { new Object[] { 'C' }, new Object[] { 'd' } });
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns), new Object[][] { new Object[] { 'C', 'd' } });
        ...
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn),
                new Object[][] { new Object[] { false }, new Object[] { true } });
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns), new Object[][] { new Object[] { false, true } });
        ...
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { null }, new Object[] { null } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn),
        ...
        assertArrayEquals(Utils.toObjectArrays(value),
                new Object[][] { new Object[] { ((Object[]) value)[0] }, new Object[] { ((Object[]) value)[1] } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn),
                new Object[][] { new Object[] { ((Object[]) value)[0] }, new Object[] { ((Object[]) value)[1] } });
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns),
        ...
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { 5 }, new Object[] { 6 } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn),
                new Object[][] { new Object[] { 5 }, new Object[] { 6 } });
        ...
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { value } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn), new Object[][] { new Object[] { value } });
        assertArrayEquals(Utils.toObjectArrays(value, multiColumns), new Object[][] { new Object[] { null, 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays(value), new Object[][] { new Object[] { 5 }, new Object[] { "5" } });
        assertArrayEquals(Utils.toObjectArrays(value, singleColumn),
    ...
    public void testBindingsToArrays() throws Exception {
        ...
        // primitive types
        assertArrayEquals(Utils.toObjectArrays(engine.eval("false")), new Object[][] { new Object[] { false } });
        ...
        assertArrayEquals(Utils.toObjectArrays(engine.eval("5"), singleColumn), new Object[][] { new Object[] { 5 } });
        ...
        assertArrayEquals(Utils.toObjectArrays(engine.eval("Java.to([false, true], \"boolean[]\")")),
                new Object[][] { new Object[] { false }, new Object[] { true } });
        assertArrayEquals(Utils.toObjectArrays(engine.eval("Java.to([false, true], \"boolean[]\")"), singleColumn),
                new Object[][] { new Object[] { false }, new Object[] { true } });
        assertArrayEquals(Utils.toObjectArrays(engine.eval("Java.to([false, true], \"boolean[]\")"), multiColumns),
        ...
        assertArrayEquals(Utils.toObjectArrays(engine.eval("Java.to([], \"int[]\")"), singleColumn), new Object[0][0]);
        assertArrayEquals(Utils.toObjectArrays(engine.eval("Java.to([], \"int[]\")"), multiColumns), new Object[0][0]);
        ...
        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.emptyEnumeration()")),
                new Object[0][0]);
        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.emptyEnumeration()"), singleColumn),
                new Object[0][0]);
        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.emptyEnumeration()"), multiColumns),
                new Object[0][0]);
        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.enumeration(_list)")),
                new Object[][] { new Object[] { 5 }, new Object[] { 6 } });
        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.enumeration(_list)"), singleColumn),
                new Object[][] { new Object[] { 5 }, new Object[] { 6 } });
        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.enumeration(_list)"), multiColumns),
                new Object[][] { new Object[] { 5, 6 } });

        assertArrayEquals(Utils.toObjectArrays(engine.eval("java.util.Collections.emptyList()")), new Object[0][0]);
    ...
    public void testJavaObjectToJsonString() {
        ...
        assertEquals(Utils.toJsonString(m),
                "{\"false\":[\"" + obj.toString() + "\"],\"" + obj.toString() + "\":[1, 2, 3],\"mm\":{\"null\":[]}}");
    }
    ...
    public void testBindingsToJsonString() throws Exception {
        ...
        assertEquals(Utils.toJsonString(engine.eval("Java.to([5.55,6.66,7.77], \"double[]\")")), "[5.55, 6.66, 7.77]");
        ...
        // object
        assertEquals(Utils.toJsonString(engine.eval("var a = {}; a.list=[1,2,3]; a.x=1; a.y=2, a.z=\"5x5x\"; a")),
