...
public class ColumnDefinitionTest {
    ...
    public void testParseOptions() {
        ...
        options.put("A''\"\' 1=2", 3);
        options.put("'B''\" 2\' = 2 ", 4);
        assertEquals(ColumnDefinition.parseOptions("'A\\'\\'\"\\' 1=2'= 3, '\\'B\\'\\'\" 2\\' = 2 '=4"), options);
    ...
    public void testFromString() {
        ...
        assertEquals(ColumnDefinition.fromString("`d 3` Nullable(String) DEFAULT '1\\'2'").toString(),
                ColumnDefinition.DEFAULT_VALUE_SUPPORT ? "`d 3` Nullable(String) DEFAULT '1\\'2'"
                        : "`d 3` Nullable(String)");
        assertEquals(ColumnDefinition.fromString("d Nullable(String) DEFAULT null").toString(), "`d` Nullable(String)");
        ...
        assertEquals(ColumnDefinition.fromString("d Nullable(DateTime) DEFAULT 1").toString(),
                ColumnDefinition.DEFAULT_VALUE_SUPPORT ? "`d` Nullable(DateTime) DEFAULT 1" : "`d` Nullable(DateTime)");
